...
def success_check():
    ...
    return ("Amy Lee is skilled in leadership" in src) and \
           ("startLinkedIn Offer See who's hiring_end" in stor) and \
           ('xml-send-body-ArrayBuffer' in xhr and '<ArrayBuffer map' in xhr)
if __name__ == "__main__":
    run_site_test('linkedin_profile', 'mv2', success_check_fn=success_check)
